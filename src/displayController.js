...
export class displayController {
  ...
  clickedAddNewTask() {
    document
      .querySelector(".addNewTaskButton")
  ...
  addNewTaskFormCaptureButtonClicked() {
    document.querySelector(".addNewTask").addEventListener("click", () => {
      let addNewTaskFormData = new FormData(
        ...
        completeTaskList: [
          {
            ...
            tasks: [
              {
                taskTitle: addNewTaskFormData.getAll("taskTitle").toString(),
                taskDetails: addNewTaskFormData
                  .getAll("taskDetails")
                  .toString(),
  ...
  urgentAndImportantButtonClicked() {
    document
      .querySelector(".urgentImportantButton")
      .addEventListener("click", () => {
  ...
  notUrgentButImportantButtonClicked() {
    document
      .querySelector(".notUrgentButImportantButton")
      .addEventListener("click", () => {
        this.clearDisplayForCurrentTaskList();
  ...
  updateDisplayTaskList(selectedProject) {
    ...
    if (initializeLocalStorage.localStorageStatus() === "Empty Storage") {
      ...
      title.innerText =
        "Welcome to Amal's To do App, below you can find the selected Project list";
      taskListDiv.append(title);

      for (
        let i = 0;
        i <
        currentLocalStorage["completeTaskList"][this.selectedProject]["tasks"]
          .length;
        i++
      ) {
        ...
        projectName.innerText =
          "Project Name: " +
          currentLocalStorage["completeTaskList"][this.selectedProject][
            "projectName"
          ];
        ...
        taskFullDetails.innerText = JSON.stringify(
          currentLocalStorage["completeTaskList"][this.selectedProject][
            "tasks"
          ][i]
        );
        ...
        this.completeButton.addEventListener("click", () => {
          this.currentTaskClass = document.querySelector(
